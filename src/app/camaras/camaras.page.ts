...
seleccionCoordenadaNTecho(){
  this.orientacionTecho = 'Norte'
  this.valorCoor5 = 372
}
...
seleccionCoordenadaOTecho(){ 
  this.orientacionTecho = 'Oeste'
  this.valorCoor5 = 372  
}
...
seleccionCoordenadaETecho(){ 
  this.orientacionTecho = 'Este'
  this.valorCoor5 = 372
}
...
seleccionCoordenadaSTecho(){
  this.orientacionTecho = 'Sur'
  this.valorCoor5 = 372
}
...
addRecinto(nombre:IonInput,temp_verano: HTMLInputElement,temp_invierno: HTMLInputElement,
 ...
 tempeTechoVer:HTMLInputElement, tempeTechoInv:HTMLInputElement, supeTecho:HTMLInputElement, suelo: IonRadioGroup,numPersonas:HTMLInputElement, cargaSensible:HTMLInputElement,cargaLatente:HTMLInputElement,caudaIda:HTMLInputElement,
  airRenovacion:HTMLInputElement,mayoracion:HTMLInputElement,lampara:IonRadioGroup,potIluminacion:HTMLInputElement ){
    this.getIdRe()
  const recinto: RecintosInterfaz = {idRec:this.idRe, nombre:nombre.value, temp_verano:temp_verano.value,
    temp_invierno:temp_invierno.value, hr_verano:hr_verano.value, hr_invierno:hr_invierno.value, ida:ida.value,nivel_filtro:nivelFiltro.value,largo:largo.value,ancho:ancho.value,alto:alto.value,
    volumen:volumen.value,cerramiento1:this.listaParamCerramiento1, cerramiento2:this.listaParamCerramiento2, cerramiento3:this.listaParamCerramiento3, cerramiento4:this.listaParamCerramiento4,orientacionTecho:this.orientacionTecho,cubierta:cubierta.value, 
    color_cubierta:colorCubierta.value,tempTechoVer:tempeTechoVer.value, tempTechoInv:tempeTechoInv.value, supTecho: supeTecho.value,
    ...
    suelo:suelo.value, supeSuelo:this.supSuelo, numPersonas:numPersonas.value, cargaSensible:cargaSensible.value,cargaLatente:cargaLatente.value,caudalIda:caudaIda.value,
    caudalAire:airRenovacion.value,mayoracion:mayoracion.value,lamparas:lampara.value,potenciaIluminacion:potIluminacion.value,equipos:this.equiposList.obtenerEquipos() }
    ...
    case 'coor4':
      ...
      case 'coor5':
        if(this.colorCerramientoCubierta == 'Claro'){
          if(this.orientacionTecho == 'Norte'){
            this.tempTechoVer = this.proyecto.t_exteriorV
          }else if(this.orientacionTecho == 'Sur'){
            this.tempTechoVer = this.proyecto.t_exteriorV + 2
          }else{
            this.tempTechoVer = this.proyecto.t_exteriorV + 3
          }
        }
        if(this.colorCerramientoCubierta == 'Medio'){
          if(this.orientacionTecho == 'Norte'){
            ...
            this.tempTechoVer = this.proyecto.t_exteriorV + 4
          }
        }
...
this.cargaSensibleRadiacionVidrio = (this.valorCoor1*this.superficieVidrios*this.tipoVidrioValor)+(this.valorCoor2*this.superficieVidrios1*this.tipoVidrioValor1)+
  (this.valorCoor3*this.superficieVidrios2*this.tipoVidrioValor2)+(this.valorCoor4*this.superficieVidrios3*this.tipoVidrioValor3)+(this.valorCoor5*this.superficieVidrios4*this.tipoVidrioValor4)
this.cargaSensibleRadiacionVidrio.toFixed(2); 
console.log("1 :", this.cargaSensibleRadiacionVidrio) // Es correcto si no contiene vidrios
...
this.cargaSensibleCerramientos = -((cerramientoExtInt1*(this.supCerra-this.superficieVidrios-this.superficiePuertas)*(this.temp_int_ver-this.tCerVer))+(this.proyecto.uh*this.superficieVidrios*(this.temp_int_ver-this.tCerVer))+(this.proyecto.up*this.superficiePuertas*(this.temp_int_ver-this.tCerVer))+(cerramientoExtInt2*(this.supCerra1-this.superficieVidrios1-this.superficiePuertas1)*(this.temp_int_ver-this.tCerVer1))+(this.proyecto.uh*this.superficieVidrios1*(this.temp_int_ver-this.tCerVer1))+(this.proyecto.up*this.superficiePuertas1*(this.temp_int_ver-this.tCerVer1))+(cerramientoExtInt3*(this.supCerra2-this.superficieVidrios2-this.superficiePuertas2)*(this.temp_int_ver-this.tCerVer2))+(this.proyecto.uh*this.superficieVidrios2*(this.temp_int_ver-this.tCerVer2))+(this.proyecto.up*this.superficiePuertas2*(this.temp_int_ver-this.tCerVer2))+(cerramientoExtInt4*(this.supCerra3-this.superficieVidrios3-this.superficiePuertas3)*(this.temp_int_ver-this.tCerVer3))+(this.proyecto.uh*this.superficieVidrios3*(this.temp_int_ver-this.tCerVer3))+(this.proyecto.up*this.superficiePuertas3*(this.temp_int_ver-this.tCerVer3))+(techoExtInt*(this.supTecho-this.superficieVidrios4-this.superficiePuertas4)*(this.temp_int_ver-this.tempTechoVer))+(this.proyecto.uh*this.superficieVidrios4*(this.temp_int_ver-this.tempTechoVer))+(this.proyecto.up*this.superficiePuertas4*(this.temp_int_ver-this.tempTechoVer))+(sueloExtInt*(this.supSuelo)*(this.temp_int_ver-this.tempSueloVer)))
...
this.cargaSensibleCerramientos.toFixed(2)
...
this.cargaSensibleAire.toFixed(2) 
...
this.cargaSensibleOcupacion.toFixed(2)
...
this.cargaTotalSensibleRefrigeracion.toFixed(2)
console.log("6 :", this.cargaTotalSensibleRefrigeracion)
...
this.cargaTotalLatenteRefrigeracion.toFixed()
...
this.potenciaRefrigeracion.toFixed(2)
...
this.cargaSensibleCerramientosInv.toFixed(2)
...
this.cargaSensibleAireInv.toFixed(2)
...
this.cargaTotalSensibleCalefaccion.toFixed(2)
...
this.potenciaCalefaccion.toFixed(2)
